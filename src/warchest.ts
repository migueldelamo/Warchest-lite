...
import { Player, Unit, User } from "./types";
...
(async () => {
  const { user1, user2 } = await initGame();
  userWolf = user1;
  userCrow = user2;
  play();
})();
      ...
      switch (inputAction) {
        ...
        case "control":
          ...
          if (hasPlayerWon(currentPlayer)) {
            winner = currentPlayer === Wolf ? userWolf : userCrow;
        ...
        case "move":
          ...
          let endRow: number | null = positionInput
            ?.split(",")[0]
            .charCodeAt(0);
        ...
        case "forfeit":
          ...
          winner = currentPlayer === Wolf ? userCrow : userWolf;
          finish = true;
          break;
        default:
          break;
